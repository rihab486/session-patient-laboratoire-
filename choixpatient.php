...
elseif ( !empty($_POST['nom']) AND !empty($_POST['adresse']) AND !empty($_POST['prenom']) AND !empty($_POST['specialite'])) {
...
<body>
    <form method="POST" action="choixpatient.php">
             ...
             <p style="display: flex; justify-content: center ;color: white;font-size: 0.9em; font-weight: 500;margin: 10px;"><?php echo $_SESSION['nom']; ?></p>
               ...
               <div class="btn-group-vertical  " style="margin: 0px">
                <a   href="test.php" class="monBoutton"> remplire le formulaire </a>
                 ...
                 <a   href="choixpatient.php" class="monBoutton" style="background-color: #2d4d6c;"> Prendre RDV </a>
      ...
      <div class="row" style="background-color: ">
        ...
        <li class="nav-item" style="background-color:">
         ...
         <li class="nav-item">
           ...
           <a class="nav-link"  href="voirResultat.php" style="color: #007BFF;font-size: 0.9em; font-weight: 500;" >Résultats</a>
...
<div class="col-5">
             ...
             <div class="form-group" >
                ...
                <p  style="display: flex; text-align:; justify-content:; color: white; font-size: 0.9em;font-weight: 500; margin: 10px; color: #3a6289">Remplissez ce formulaire pour préparer un RDV:</p>
...
if (isset($_GET['a'])) {
  ...
  $erreur=$_GET['a'];
  echo '<font style="font-weight: 500;font-size: 0.78em;">'.$erreur."</font><br>";
}
...
?></span> 
               ...
               <?php echo "<button type='submit' name='bout' class='btn btn-primary' onclick='return confirm(\"voulez vous confirmer ces informations? \");' ><span style='font-weight: bold; font-size: 0.8em;'> Envoyer </span></button>" ; ?> 

               

               <a style="font-weight: bold; font-size: 0.8em;color: white;height: 38px;padding: 9px ;" class="btn btn-primary" href="supprimerRDV.php"   onclick='return confirm("voulez vous supprimer cette demande? "); ' >Supprimer la demande</a> 
